# The main() function will execute when this action is invoked
# @param Cloud Functions actions require a single parameter, which must be provided as a JSON object.
